...
**現状 HEAD**:
- medadapt: 後述（v4.14 commit）
- adapt: 後述（v4.14 HERO修正）
- one-touch: 後述（v4.14 HERO修正）
...
|---|---|---|---|
| medadapt | v4.14 commit | myaruze.tamjump.com | `docs/DESIGN_yaruze_v4_14_2026-05-25.html` |
| adapt（やるゼ!親） | v4.14 commit | yaruze.tamjump.com | 同上の §66-3-1 で言及 |
| one-touch（ｔやるゼ!） | v4.14 commit | tyaruze.tamjump.com | 同上の §66-3-2 で言及 |
