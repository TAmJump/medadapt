...
**最終更新**: 2026-05-26（v5.0.6 / LP HERO 透け感調整 + 医師写真差し替え + buntyan 事案ルール反映）

**現状 HEAD**:
- medadapt: v5.0.6（`dacdd83`）
...
| **v5.0.6** | 医師写真7名差し替え（テキストなし新素材）+ HERO 透け感調整 + 大画面レイアウト修正 + buntyan 事案ルール反映 | `dacdd83` ★HEAD |
