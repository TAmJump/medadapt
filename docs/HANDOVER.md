...
**最終更新**: 2026-05-25（v4.14 / 3兄弟HERO統一・マッサージ導線・保険医療機関名統一）

**現状 HEAD**:
- medadapt: `5e5c2c9`（v4.14 / 3兄弟HERO統一・マッサージ導線・保険医療機関名統一）
- adapt: `4499682`（v4.14 HERO修正）
- one-touch: `57d05ee`（v4.14 HERO修正）
...
v4.14 セッション（2026-05-25）で大下さん指示の以下 5 件はすべて完了:
- ⚡A. ｍやるゼ！app.html のマッサージ系ページ導線新設 ✅
- ⚡B. やるゼ！親LP HEROの顔と文字の重なり解消 ✅
- ⚡C. ｔやるゼ！LP HEROの顔と文字の重なり解消 ✅
- ⚡D. ｍやるゼ！HEROを「写真透けスタイル」に統一 ✅
- 🆕 同意書 PDF の保険医療機関名を「医療法人コンパス」に統一 ✅

次の作業候補は §8-3 中長期未着手タスク参照。
...
|---|---|---|---|
| medadapt | `5e5c2c9` | myaruze.tamjump.com | `docs/DESIGN_yaruze_v4_14_2026-05-25.html` |
| adapt（やるゼ!親） | `4499682` | yaruze.tamjump.com | 同上の §66-3-1 で言及 |
| one-touch（ｔやるゼ!） | `57d05ee` | tyaruze.tamjump.com | 同上の §66-3-2 で言及 |

3兄弟LP すべて v4.14 で HERO「写真透けスタイル」統一完了。ｍやるゼ! app.html はマッサージ・鍼灸導線新設＋保険医療機関名「医療法人コンパス」統一済み。本番デプロイは GitHub Pages 経由（1-2分で反映）。
